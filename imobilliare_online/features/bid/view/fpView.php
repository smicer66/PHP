...
$specialFeaturesSQL=PROJECT::getSpecialFeatureProperties();
$array_ids=array();
				...
				<tr>
				  <td valign="top" colspan="4">
				  		<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
							  <td class="textHeaderStyle2 bgHeaderCell"><img src="images/154.png" width="16" height="16" />&nbsp;&nbsp;Hottest Properties</td>
							</tr>
					  	</table></td>
				</tr>
					<?php
					$countre1=0;
					 for($counter=0;$counter<3;$counter++)
					 {
						...
						?>
						  ...
						  echo "<a href='index.php?fid=".FEATURE::getId('Project')."&fiid=".$propDet['id']."'>";?><img src="images/info1.png" alt="view information" title="View project information" class='icon' border='0' /></a>&nbsp;&nbsp;
...
<table width="29%" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    <td class="listingCells" align="center"><a href="index.php?fid=<?php echo FEATURE::getId('Project')."&list&bt=".BILLING::getBillingTypeId('Special Listing');?>">Find Other Hot Properties</a></td>
  </tr>
</table>
