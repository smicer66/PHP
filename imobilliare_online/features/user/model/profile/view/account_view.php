  ...
  <tr>
    <td bgcolor="#FFFCEC" class=""><br />
		...
		if((($ext[(sizeof($ext) - 1)]=='png') || ($ext[(sizeof($ext) - 1)]=='jpg') || ($ext[(sizeof($ext) - 1)]=='gif') || ($ext[(sizeof($ext) - 1)]=='jpe') || ($ext[(sizeof($ext) - 1)]=='jpeg') || ($ext[(sizeof($ext) - 1)]=='bmp') || ($ext[(sizeof($ext) - 1)]=='tiff')) && file_exists("features/user/Employer/view/images/".$ext[0].".".$ext[1]))
		{
			...
			{
				//http://localhost:70/naijalancer07042011/index.php?fid=9&mod=1&us=2
				echo "<a href='?fid=".FEATURE::getId('User')."&mod=1&us=".USERTYPE::getUserTypeId('Employer')."'>";
			}*/
			echo "<img src='features/user/Employer/view/images/".$ext[0].".".$ext[1]."' width='78' height='82' border='0'>";
			/*if($_SESSION['uid']==$_REQUEST['fiid'])
			{
				echo "</a>";
			}*/
			
			//echo getPictureFileName($fileArray[0]['id']);
