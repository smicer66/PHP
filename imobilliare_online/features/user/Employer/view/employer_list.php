...
{
	if($result_spec['userTypeId']==USERTYPE::getUserTypeId('Employer'))
	{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="63%" valign="top">
  	...
  	<?php
  echo PORTLET::displayHeader("Employers on Imobilliare", "<a href='?fid=".FEATURE::getid('User')."&members=dev'>Rate Developers</a>");
	?>
</table>
    ...
    <td width="37%" valign="top">
		...
		<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
		  ...
		  echo PORTLET::displayHeader("Ratings", "");
			...
			<br>
			<?php
			if((!isset($_SESSION['uid'])) || (USER::getUserTypeId($_SESSION['uid'])!=USERTYPE::getUserTypeId('Developer')))
			{
			...
			?>
			<input name="EMPLOYER" type="submit" class="button11" value="Rate" <?php echo $disabled;?>>
			<br>
			<br>
			<div align="right">
			<a href="?fid=<?php echo FEATURE::getid('User')."&members=dev";?>">Rate Developers</a><br />
			<!--<a href="?fid=<?php echo FEATURE::getid('User')."&members=dev";?>">About Our Rating System </a>--></div>
			 </td>
			</tr>
		  </table><br>
