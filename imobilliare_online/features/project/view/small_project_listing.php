<?php
	...
	if((isset($_REQUEST['search_start'])) && ($_REQUEST['fid']==FEATURE::getId('PROJECT')))//start of project listing
	{
	...
	else
	{
		...
		$projectListingSQL=PROJECT::getProjectListing($start, $end, NULL, 'id', 'DESC');
...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
		...
		<table width="98%" border="0" cellpadding="0" cellspacing="0" class="onlyBorderAlone defaultBgColor">
	  	...
	  	<?php
			...
			{		
				...
				{
					echo "<tr>";
					echo "<td colspan='3' align='left' class='".$class."'><A href='?fid=".FEATURE::getId('Project')."&fiid=".$resultX['id']."'>".$resultX['header']."</A></td>";
					echo "</tr>";
				}			
			}
	 ...
	 <tr><td>&nbsp;</td><td align='right'><br><a href='?fid=<?php echo FEATURE::getId('project')."&list&bt=2";?>'>View All</a></td></tr> 
    </table>
