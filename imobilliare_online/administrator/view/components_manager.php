    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        <td width="22%" valign="top" class="cellType7"><table width="99%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="cellType2"><p>Administrative Functions</p>
              </td>
          </tr>
          <tr>
            <td class="cellType1"><img src="../images/154.png" width="16" height="16" align="absmiddle" />&nbsp;<?php $siteIn=new Site(); if($siteIn->siteOnline){?><a href="../install/installer.php"><?php }?>Install&nbsp;/&nbsp;<a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('portal_updater'); ?>">Updates</a></td>
          </tr>
          <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td colspan="5" align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Components Manager </span></td>
          </tr>
          <tr>
            <td width="20%" align="center" valign="bottom" bgcolor="#F8F8F8" class="cellType7"><a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('images_uploader'); ?>"><img src="../images/Picture.png" width="48" height="48" border="0" /></a><br />
              <a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('images_uploader'); ?>">Image Uploader </a></td>
            <td width="20%" align="center" valign="bottom" bgcolor="#F8F8F8" class="cellType7"><a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('menu_creator'); ?>"><img src="../images/Panel Settings.png" width="48" height="48" border="0" /></a><br />
              <a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('menu_creator'); ?>">Menus</a></td>
            <td width="20%" align="center" valign="bottom" bgcolor="#F8F8F8" class="cellType7"><a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('position_creator'); ?>"><img src="../images/Address Book.png" width="48" height="48" border="0" /></a><br />
              <a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('position_creator'); ?>">Page Positioning </a></td>
            <td width="20%" align="center" valign="bottom" bgcolor="#F8F8F8" class="cellType7"><a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('footer_creator'); ?>"><img src="../images/Edit.png" width="48" height="48" border="0" /></a><br />
              <a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('footer_creator'); ?>">Footer</a></td>
            <td width="20%" align="center" valign="bottom" bgcolor="#F8F8F8" class="cellType7">&nbsp;</td>
          </tr>
        </table></td>
      </tr>
