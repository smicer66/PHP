    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
          ...
          <tr>
			 ...
			 ?>" method="post" enctype="multipart/form-data">
                      <div class='scrollYes'>
                        <table width="100%" border="0" cellspacing="2" cellpadding="5">
                          <tr>
                            <td width="71%" valign="top" class="cellType2">Property Category</td>
                            <td width="19%" valign="top" class="cellType2">Property Type </td>
                            <td width='10%' valign="top" class="cellType2">Active<br />
                              (Yes)?</td>
                          </tr>
                          <?php
		
			$str="SELECT * FROM `".DEFAULT_DB_TBL_PREFIX."_property_category`";
			$sql= $mysql->query($str);
			while($result = $mysql->fetch_assoc_mine($sql))
			{
				...
				echo "<tr>
				 ...
				 echo "
				 <td valign='top' class='cellType7'>".PROPERTY::getPropertyType($result['propertyTypeId'])."</td>";
				 echo "
		...
		?>
                        ...
                        <table width="100%" border="0" cellspacing="2" cellpadding="5">
                          <tr>
                            <td colspan='3' valign="top" class="cellType11"><input name="EditCategory" type="submit" id="Edit" value="Update" /></td>
                          </tr>
                        </table>
                      </div>
                    </form></td>
