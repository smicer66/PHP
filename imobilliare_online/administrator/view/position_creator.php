    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        <td width="16%" valign="top" class="cellType7"><table width="99%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="2" cellpadding="5">
              ...
              <tr>
                <td class="cellType11"><img src="view/images/154.png" width="16" height="16" align="absmiddle" />&nbsp;<a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('position_updater'); ?>">Position Updater </a> </td>
              </tr>
              <tr>
                <td class="cellType11"><img src="view/images/154.png" width="16" height="16" align="absmiddle" />&nbsp;<a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('position_creator'); ?>">Position Creator </a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Components Manager - Position Creator </span></td>
          </tr>
          <tr>
			 ...
			 ?>" method="post" enctype="multipart/form-data">
                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                        ...
                        <tr>
                          <td><table width="100%" border="0" cellspacing="2" cellpadding="5">
                              <tr>
                                <td width="45%" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="5">
							<?php
							for($count=1;$count<6;$count++)
							{
								echo "<tr>
								<td width='40%' class='cellType11'>Enter Position #".$count.": </td>
								<td class='cellType10'><input name='position".$count."' type='text' id='position".$count."' /></td>
							  </tr>";
							}	
							?>
							<tr>
                                <td class='cellType11' valign="top">&nbsp;</td>
								<td class='cellType10' valign="top"><input name="CreatePosition" type="submit" id="Create" value="Create" /></td>
                              </tr></table></td>
                                <td width="43%" rowspan="3" align="right" valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="0" class="cellType4">
                      <tr>
                        <td class="cellType2">Existing Positions</td>
                      </tr>
                      <tr>
                        <td class="cellType10"><?php
	$result=POSITION::getAvailablePositions();
...
<div class="texttype2">*Do Not Create Positions Already Existing!</div>				  </td>
                              </tr>
