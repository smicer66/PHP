...
{
	require_once("../../features/sitemap/site_map.php");
}
    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Features Manager - Site Map Update </span></td>
          </tr>
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType7"> <?php
			  $error->displayComponent($_REQUEST['errcpj'], $_SERVER['HTTP_REFERER'], 1);?><form action="<?php 
			...
			else
			{
			 ...
			 ?>" method="post">
			  ...
			  <table width="100%" border="0" cellspacing="2" cellpadding="5">
                ...
                <tr>
                  <td valign="top" class="cellType2">Site Map Entries</td>
				  <td width='5%' valign="top" class="cellType2">Status<br />
				    (Yes)?</td>	
                  </tr>
                <?php
		
			$str="SELECT * FROM `".DEFAULT_DB_TBL_PREFIX."_sitemap`";
			$sql= $mysql->query($str);
			while($result = $mysql->fetch_assoc_mine($sql))
			{
				...
				echo "<tr>
				  ...
				  <a href='site_map_creator.php?mod=1&id=".$result['id']."'>".getRealData($result['name'])."</a></td>
		...
		?>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="5">
                <tr>
                  <td colspan='3' valign="top" class="cellType11"><input name="EditSiteMap" type="submit" id="Edit" value="Update" /></td>
                    </tr>  
              </table>
			  </div>
            </form>            </td>
