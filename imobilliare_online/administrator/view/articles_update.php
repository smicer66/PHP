    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Features Manager - Articles Update </span></td>
          </tr>
          <tr>
			...
			else
			{
			 ...
			 ?>" enctype="multipart/form-data">
			  ...
			  <table width="100%" border="0" cellspacing="2" cellpadding="5">
                ...
                <tr>
                  <td valign="top" class="cellType2">Articles Name<br />
                    <span class="texttype2">[Click to Update Articles Contents]</span></td>
			...
			if(!isSuperAdmin($_SESSION['uid']))
			{
				...
				$str="SELECT * FROM `".DEFAULT_DB_TBL_PREFIX."_articles` WHERE `section` = '".$userDet['section']."' AND `sectionId` = '".$userDet['sectionId']."'";
			}
			else
			{
			...
			while($result = $mysql->fetch_assoc_mine($sql))
			{
				...
				echo "<tr>
				  ...
				  <a href='?fid=".ADMINISTRATOR::getAdminFunctionId('articles_creator')."&mod=1&id=".$result['id']."'>".getRealData($result['name'])."</a></td>
		...
		?>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="5">
                <tr>
                  <td colspan='3' valign="top" class="cellType11"><input name="EditArticles" type="submit" id="Edit" value="Update" /></td>
                    </tr>  
              </table>
			  </div>
            </form>            </td>
