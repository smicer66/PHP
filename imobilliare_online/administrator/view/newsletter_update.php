    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Features Manager - Newsletter Update </span></td>
          </tr>
          <tr>
			...
			else
			{
			 ...
			 ?>" enctype="multipart/form-data">
              <table width="100%" border="0" cellspacing="2" cellpadding="5">
                ...
                <tr>
                  <td width="72%" valign="top" class="cellType2">Newsletter Name<br />
                    <span class="texttype2">[Click to Update Newsletter Contents]</span></td>
				  <td width='7%' valign="top" class="cellType2">Active<br />
				    (Yes)?</td>
				  <td width='21%' valign="top" class="cellType2">Display on Frontpage?<br />
				    (Yes)?</td>
                  </tr>
                <?php
		
			$str="SELECT * FROM `".DEFAULT_DB_TBL_PREFIX."_newsletter`";
			$sql= $mysql->query($str);
			while($result = $mysql->fetch_assoc_mine($sql))
			{
				...
				echo "<tr>
				  ...
				  <a href='newsletter_creator.php?mod=1&id=".$result['id']."'>".getRealData($result['name'])."</a></td>
				  <td valign='top' class='cellType7'><input name='status".$result['id']."' type='checkbox' value='1' ".$checked."/></td>
				  <td valign='top' class='cellType7'><input name='fpYes".$result['id']."' type='checkbox' value='1' ".$checked1."/></td>";
				   $checked='';
				   $checked1='';
		...
		?>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="5">
                <tr>
                  <td colspan='3' valign="top" class="cellType11"><input name="EditNews" type="submit" id="Edit" value="Update" /></td>
                    </tr>  
              </table>
            </form>            </td>
            </tr>
