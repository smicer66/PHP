      ...
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          ...
          <tr>
			...
			$str="SELECT * FROM `".DEFAULT_DB_TBL_PREFIX."_menu`";
			...
			while($result = $mysql->fetch_assoc_mine($sql))
			{
				...
				echo "<tr>
				  <td valign='top' class='cellType11'><a href='".$_SERVER['PHP_SELF']."?delPMId=".$result['id']."'><img src='../images/delete.png' height=15px border=0 align='absmiddle' title='delete' /></a>&nbsp;&nbsp;<a href='?fid=".ADMINISTRATOR::getAdminFunctionId('menu_item_updater')."&mid=".$result['id']."'><img src='../images/Egg.png' height=15px border=0 align='absmiddle' title='Menu Items' /></a>&nbsp;&nbsp;
				  <a href='menu_creator.php?mod=1&id=".$result['id']."'>".getRealData($result['name'])."</a></td>";
		...
		?>
                  ...
                  <table width="100%" border="0" cellspacing="2" cellpadding="5">
                    <tr>
                      <td colspan='3' valign="top" class="cellType11"><input name="EditMenu" type="submit" id="EditMenu" value="Update" /></td>
                    </tr>
                  </table>
                </div>
              </form></td>
