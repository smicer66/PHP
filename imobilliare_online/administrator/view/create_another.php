    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Features Manager - Finished? </span></td>
          </tr>
          <tr>
            <td align="center" valign="bottom" bgcolor="#F8F8F8" class="cellType7"><?php
			  $error->displayComponent($_REQUEST['errcpj'], $_SERVER['PHP_SELF']."?".$_SERVER['QUERY_STRING'], 1);
			  ?>
			...
			else
			{
			 ...
			 ?>" method="post">
              <table width='100%' border='0' cellspacing='5' cellpadding='5'>
                ...
                <tr>
                  <td align="center" valign='top' class='altBg2'><strong>Create Another Listing </strong><br />
                    <a href="<?php echo 'index.php?fid='.ADMINISTRATOR::getAdminFunctionId('property_creator');?>">Yes</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php">No</a> </td>
                  </tr>
              </table>
            </form>
            </td>
