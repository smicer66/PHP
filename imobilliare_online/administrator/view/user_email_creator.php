...
{
	$resultMOD = $userType->getUserTypeDetails($_REQUEST['id']);
}
    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Features Manager - User Email Creator </span></td>
          </tr>
          <tr>
			...
			else
			{
			 ...
			 ?>" method="post">
              <table width="100%" border="0" cellspacing="5" cellpadding="5">
                ...
                <tr>
                  <td width="28%" class="cellType11">Select A User To Create An Email:</td>
                  <td class="cellType10"><?php
				  echo "<select name='users'>".append_user_no_email(getRealData($resultMOD['name']))."</select>";
		?></td>
                </tr>
				<tr>
                  <td width="28%" class="cellType11">Password:</td>
                  <td class="cellType10"><?php
				  echo "<input type='password' name='password' />";
		?></td>
                </tr>
				<tr>
                  <td width="28%" class="cellType11">Confirm Password:</td>
                  <td class="cellType10"><?php
		...
		?></td>
			...
			echo "<input name='CreateEmail' type='submit' id='Create' value='Create' />";
					?>&nbsp;</td>
                </tr>
              </table>
            </form></td>
