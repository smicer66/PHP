    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        <td width="16%" valign="top" class="cellType7"><table width="99%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="2" cellpadding="5">
              ...
              <tr>
                <td class="cellType11"><img src="view/images/154.png" width="16" height="16" align="absmiddle" />&nbsp;<a href="search_modifier.php">Tune Search Function </a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Features - Search Modifier </span></td>
          </tr>
          <tr>
			...
			<table width="100%" border="0" cellspacing="5" cellpadding="5">
              <tr>
                <td width="28%" bgcolor="#CCCCCC" class="cellType2">Search Features: </td>
                <td bgcolor="#CCCCCC" class="cellType2">&nbsp;</td>
              </tr>
              <tr>
                <td valign="top" class="cellType11">[Select Features which can be searched Applicable]</td>
                <td valign="top" class="cellType10"><div class='scrollYes'><?php
		...
		while($result = $mysql->fetch_assoc_mine($sql))
		{
			...
			echo "<input type='checkbox' name='checkbox".$result['id']."' ".$checked." value='1' />
			&nbsp;&nbsp;".$result['name']."<br />
			<br />";
		}
	?>
                    <input name="SubmitSearchModifier" type="submit" id="SubmitSearchModifier" value="Apply" />
                </form></div></td>
              </tr>
            </table>
			</td>
