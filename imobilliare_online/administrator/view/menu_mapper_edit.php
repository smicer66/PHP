  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers"><span class="style1">Component Manager - View Menu  Mapped</span></span></td>
          </tr>
          <tr>
			...
			<table width="100%" border="0" cellspacing="5" cellpadding="5">
              <tr>
                ...
                <td width="61%" class="cellType2">View Menu Mapping </td>
              </tr>
              <tr>
                <td valign="top" class="cellType11">View Menus Mapped To This Feature:</td>
	...
	else
	{
		...
		echo "<tr><td width='20%' align='left'><strong>Select Feature:</strong></td>
			<td align='left'><select name='feature' id='featMenu' name='featMenu' onChange='validate(this.value, this.id)' >".append_feature_list()."</select></td>
			</tr>";
		echo "<tr><td width='20%' colspan='2' align='left' valign='top'>";
		echo "<div id='logoStatus'><table width='100%' border='0' cellspacing='0' cellpadding='5'>";
		
		echo "<tr><td width='20%' align='left' colspan='2'><em>Select A Feature (And its Feature Entry) to View the current mapping of that feature</em></td>
			</tr>";
