    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Features Manager - Add Funds </span></td>
          </tr>
          <tr>
			...
			else
			{
			 ...
			 ?>" method="post">
              <table width='100%' border='0' cellspacing='5' cellpadding='5'>
                ...
                <tr>
                  <td width="28%" valign='top' class="cellType11">Select The Bank: </td>
                  <td valign='top' class="cellType10"><select name="bank" id="bank" >
                    <?php echo append_option_bank($_COOKIE['bank']); ?>
                  </select></td>
                </tr>
                <tr>
                  <td valign='top' class="cellType11">Credit Whose Account: </td>
                  <td valign='top' class="cellType10"><select name="payin_name" id="payin_name" >
                    <?php 
					echo append_user_list(USERTYPE::getUserTypeId('Agent'), $_COOKIE['names']); ?>
                  </select></td>
                </tr>
                <tr>
                  <td valign='top' class="cellType11">Provide the Pay-In Teller Number: </td>
                  <td valign='top' class="cellType10"><?php
		echo "<input type='text' name='payin_tellerNo' value='".$_COOKIE['payin_tellerNo']."' />";
		
		?></td>
                </tr>
                <tr>
                  <td valign='top' class="cellType11">How Much Did You Pay In: </td>
                  <td valign='top' class="cellType10"><?php
		
			echo "<input type='text' name='amount'  value='".$_COOKIE['amount']."' />";
		?> <span class="warningText">e.g. 5000, 140000 (no commas, no spaces pls)</span></td>
                </tr>
                <tr>
                  <td valign='top' class="cellType11">&nbsp;</td>
                  <td valign='top' class="cellType10">
				  <input name='Billing_Add' type='submit' id='Create' value='Add Funds' /></td>
                </tr>
              </table>
            </form>
            </td>
