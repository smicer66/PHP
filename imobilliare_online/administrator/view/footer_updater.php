    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><strong>Components ::: Footer Updater </strong></td>
          </tr>
          <tr>
			...
			else
			{
			 ...
			 ?>">
			  ...
			  <table width="100%" border="0" cellspacing="2" cellpadding="5">
                ...
                <tr>
                  <td width="77%" valign="top" class="cellType2">Footer Name <br />
                      <span class="texttype2">[Click to Update footer entry]</span>                    </td>
				  <td width='10%' valign="top" class="cellType2">Active<br />(Yes)?</td>
                  </tr>
                <?php
		
			$str="SELECT * FROM `".DEFAULT_DB_TBL_PREFIX."_footer`";
			$sql= $mysql->query($str);
			while($result = $mysql->fetch_assoc_mine($sql))
			{
				...
				echo "<tr>
				  <td valign='top' class='cellType11'>";
				   	...
				   	echo "<a href='footer_creator.php?mod=1&id=".$result['id']."'>";
				  echo ucfirst(strtolower(getRealData($result['name'])))."</a></td>";
				
				 echo "<td valign='top' class='cellType7'><input name='status".$result['id']."' type='checkbox' value='1' ".$checked."/></td>";
				 $checked='';
		...
		?>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="5">
                <tr>
                  <td colspan='3' valign="top" class="cellType11"><input name="EditFooterListing" type="submit" id="Edit" value="Update" /></td>
                    </tr>  
              </table>
			  </div>
              </form></td>
