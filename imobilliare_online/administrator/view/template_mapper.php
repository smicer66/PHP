    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
          ...
          <tr>
			...
			else
			{
			 ...
			 ?>" enctype="multipart/form-data">
			  ...
			  <table width="100%" border="0" cellspacing="2" cellpadding="5">
                ...
                <tr>
                  <td valign="top" class="cellType2">Feature Name
				</td>
				  <td width='20%' valign="top" class="cellType2">Display Using This Template:</td>
                  </tr>
                <?php
			...
			while($result = $mysql->fetch_assoc_mine($sql))
			{
				echo "<tr>
				  ...
				  ".$result['name']."</td>";
				 echo "
				 <td valign='top' class='cellType7'><select name='templateId".$result['id']."'/>".append_option_format_template($result['mainViewTemplateId'])."</select></td>";
				 echo "</tr>";
		...
		?>
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="5">
                <tr>
                  <td colspan='3' valign="top" class="cellType11"><input name="MapTemplate" type="submit" id="Edit" value="Update" /></td>
                    </tr>  
              </table>
			  </div>
            </form>            </td>
