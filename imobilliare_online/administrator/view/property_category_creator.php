    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Features Manager - Property Type Category Creator </span></td>
          </tr>
          <tr>
			...
			else
			{
			 ...
			 ?>" method="post">
              <table width="100%" border="0" cellspacing="5" cellpadding="5">
                <tr>
                  <td width="28%" valign="top" class="cellType11">Select Property Type:</td>
                  <td colspan="2" valign="top" class="cellType10"><?php
	  echo "<select id='propertyCategory' name='propertyCategory' class='formtextboxtype2'>".append_property_type($resultMOD['propertyTypeId'])."</select>";
	  ?></td>
                </tr>
                <tr>
                  <td valign="top" class="cellType11">Property Type Category:<br /><span class="warningText">e.g. 1-bedroom flat, 3-hectares land</span></td>
                  <td width="27%" valign="top" class="cellType10"><input name="catName" type="text" value='<?php echo $resultMOD['name'];?>' ></td>
                  <td width="45%" rowspan="2" valign="top" class="cellType10"><table width="100%" border="0" cellpadding="5" cellspacing="0" class="cellType4">
                      <tr>
                        <td class="cellType2">Existing Catgories</td>
                      </tr>
                      <tr>
                        <td class="cellType10"><?php
	$result=PROPERTY::getPropertyCategoryList();
...
<div class="texttype2">*Do Not Create Property Categories Already Existing!</div>				  &nbsp;</td>
				...
				<tr>
				  <td valign="top" class="cellType11">Category Description:</td>
				  <td valign="top" class="cellType10"><textarea name="description"><?php if((isset($_REQUEST['mod'])) && ($_REQUEST['mod']==1) && (isset($_REQUEST['id'])) && (is_numeric($_REQUEST['id'])==1))
		{
			echo  $resultMOD['description'];
		}?></textarea></td>
				  </tr>
				<tr>
                  <td colspan="2" valign="top" class="cellType10"><?php
		...
		{
			echo "<input name='createPropCat' type='submit' id='Create' value='Create' />";
		}          
					?></td>
                </tr>
              </table>
