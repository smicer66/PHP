    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
			 ...
			 ?>" method="post" enctype="multipart/form-data">
                      <div class='scrollYes'>
                        <table width="100%" border="0" cellspacing="2" cellpadding="5">
                          <tr>
                            <td width="71%" valign="top" class="cellType2">Property Type </td>
                            <td  valign="top" class="cellType2">Active<br />
                              (Yes)?</td>
                          </tr>
                          <?php
		
			$str="SELECT * FROM `".DEFAULT_DB_TBL_PREFIX."_property_type`";
			$sql= $mysql->query($str);
		...
		?>
                        ...
                        <table width="100%" border="0" cellspacing="2" cellpadding="5">
                          <tr>
                            <td colspan='3' valign="top" class="cellType11"><input name="EditPropType" type="submit" id="Edit" value="Update" /></td>
                          </tr>
                        </table>
                      </div>
                    </form></td>
