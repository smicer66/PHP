    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        <td width="16%" valign="top" class="cellType7"><table width="99%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="cellType1"><img src="view/images/154.png" width="16" height="16" align="absmiddle" />&nbsp;
                <?php $siteIn=new Site(); if($siteIn->siteOnline){?>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Portal Updates!</span></td>
          </tr>
          <tr>
            <td align="center" valign="bottom" bgcolor="#F8F8F8" class="cellType7"><?php
			  $error=new Error();
					...
					$error->displayComponent($_REQUEST['errcpj'], $_SERVER['PHP_SELF'], 1);
			  ?>
                    <form action="<?php 
			...
			else
			{
			 ...
			 <?php
			 if(!isset($_REQUEST['fide']))
			 {
			 ?>
                      <table width="100%" border="0" cellspacing="2" cellpadding="5">
                        
                        <tr>
                          <td colspan='2' class="cellType2">Upload the update </td>
                        </tr>
                        <tr>
		<td class='cellType11' width='28%'>Select Update File:</td>
		<td class='cellType10'><input name='userfile' type='file' id='userfile' /></td></tr>
		<tr>
		<td class='cellType11' width='28%'>&nbsp;</td>
		<td class='cellType10'><input name='Update_Upload' type='submit' id="Update_Upload" value='Upload' /></td></tr>
		 </table>
		 	 <?php
			 }
			 else
			 ...
			 ?>
			 	<table width="100%" border="0" cellspacing="2" cellpadding="5">
                        ...
                        <tr>
                          <td class="cellType2">Run The Update? <span class="cellType10">
                            <input name='Update_Run' type='submit' id="Update_Run" value='Yes' />
                          </span></td>
                        </tr>
		 </table>
		 	<?php
