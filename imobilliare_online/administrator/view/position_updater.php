    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Components Manager - Position Update </span></td>
          </tr>
          <tr>
			 ...
			 ?>" method="post" enctype="multipart/form-data">
                      <div class='scrollYes'>
                        <table width="100%" border="0" cellspacing="2" cellpadding="5">
                          <tr>
                            <td valign="top" class="cellType2">Position Name </td>
			...
			while($result = $mysql->fetch_assoc_mine($sql))
			{
				...
				echo "<tr>
				  <td valign='top' class='cellType11'><a href='".$_SERVER['PHP_SELF']."?delPositionId=".$result['id']."'><img src='../images/delete.png' height=15px border=0 align='absmiddle' title='delete' /></a>&nbsp;&nbsp;".getRealData($result['name'])."</td>";
		...
		?>
                        ...
                        <table width="100%" border="0" cellspacing="2" cellpadding="5">
                          <tr>
                            <td colspan='3' valign="top" class="cellType11"><input name="EditPosition" type="submit" id="Edit" value="Update" /></td>
                          </tr>
                        </table>
                      </div>
                    </form></td>
