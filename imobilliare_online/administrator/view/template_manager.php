    ...
    <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="5" class="cellType3">
      <tr>
        <td width="22%" valign="top" class="cellType7"><table width="99%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="cellType1"><img src="../images/154.png" width="16" height="16" align="absmiddle" />&nbsp;<?php $siteIn=new Site(); if($siteIn->siteOnline){?><a href="../install/installer.php"><?php }?>Install<?php $siteIn=new Site(); if($siteIn->siteOnline){?></a><?php }?>&nbsp;/&nbsp;<a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('portal_updater'); ?>">Updates</a></td>
          </tr>
          <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
          <tr>
            <td colspan="5" align="left" valign="bottom" bgcolor="#F8F8F8" class="cellType6"><span class="headers">Template Manager </span></td>
          </tr>
          <tr>
            <td width="20%" align="center" valign="bottom" bgcolor="#F8F8F8" class="cellType7"><a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('template_updater'); ?>"><img src="../images/starter.jpg" width="48" height="48" border="0" /></a><br />
              <a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('template_updater'); ?>">Templates</a></td>
            <td width="20%" align="center" valign="bottom" bgcolor="#F8F8F8" class="cellType7"><a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('template_installer'); ?>"><img src="../images/window.png" width="48" height="48" border="0" /></a><br />
              <a href="<?php echo "?fid=".ADMINISTRATOR::getAdminFunctionId('template_installer'); ?>">New Template </a></td>
