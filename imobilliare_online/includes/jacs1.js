        ...
        {switch (cal.id)
            {case 'EnterYourIDHere':
             ...
             default:
                ...
                cal.baseYear = dateNow.getFullYear()-110;

                // How many years do want to be valid and to show in the
                // drop-down list?

                cal.dropDownYears = 120;
                ...
                try   {jacsSetLanguage(cal);}
                    ...
                    // cal.monthNames          = ['Jan','Feb','Mar','Apr','May','Jun',
					  ...
					  cal.monthNames          = ['01','02','03','04','05','06',
                                                '07','08','09','10','11','12'];
                ...
                cal.dateFormat  = 'YYYY-MMM-DD'; // e.g. 'MMM-DD-YYYY' for the US
				...
				cal.dates = new Array();
                //default value:
				//cal.dates[0] = [new Date(dateNow.getFullYear(),dateNow.getMonth(),dateNow.getDate()),new Date(dateNow.getFullYear()+5,dateNow.getMonth(),dateNow.getDate()+10)];
				
				cal.dates[0] = [new Date(dateNow.getFullYear(),dateNow.getMonth(),dateNow.getDate()),new Date(1900,01,01)];
